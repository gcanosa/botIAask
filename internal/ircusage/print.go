...
var userLines = []line{
	...
	{cmd: "!movie <title>", desc: "Year, IMDb rating, short plot (OMDb; omdb.api_key or OMDB_API_KEY)"},
...
var adminLines = []line{
	...
	{cmd: "!stats", desc: "Colorful bot stats: uptime, 24h activity, channels, data counts, services, host CPU/RAM/heap"},
